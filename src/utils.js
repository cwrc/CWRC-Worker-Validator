...
export const parseXMLString = (content) => {
  const parser = new window.DOMParser();
  const xml = parser.parseFromString(content, 'text/xml');
  return xml;
};

export const evaluateXPath = (docXML, xpath) => {
...
export const getXPathForElement = (el, xml) => {
  let xpath = '';
  let pos, tempitem;
 ...
 */
export const getFullNameFromDocumentation = (documentation) => {
